...
namespace eBettingSystemV2.Services.Servisi
{
    public class FetchService : IFetch
    {
        ...
        public System.Timers.Timer aTimer { get; set; } = new System.Timers.Timer(); //visak
        ...
        public static List<Podaci> eventsList = new List<Podaci>(); //koristi se
        ...
        public async Task FetchEventData()
        {
           ...
           List<FetchEventModel> EventName2 = FetchAllEvents2();
        ...
        public List<FetchEventModel> FetchAllEvents2()
        {
            ...
            for (int y = 0; y < brojcompetition; y++)
            {
                ...
                for (int i = 0; i < eventsListFetched.Count(); i++)
                {
                    ...
                    FetchModel[y]._eventi.Add(new Podaci { EventName = eventsListFetched[i].InnerText});
                }
            }
        ...
        //Fetch kategorija competition po danu
